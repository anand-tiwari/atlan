        ...
        <div class="table">
            <table class="table__container">
                <tr class="table__header table__grid">
                    <template :key="tableField.field"
                              v-for="tableField in candidateHeaderFilter">
                        <td v-if="tableField.isFilter"
                ...
                <template :key="candidate.id" v-for="(candidate, index) in candidates">
                    <tr class="table__grid" :class="{'even': index % 2 === 0,'odd': index % 2 === 1}" >
